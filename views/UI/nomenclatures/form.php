...
$singular_nomenclature = Inflector::singular($nomenclature_name);
?>
<script>
function redirect() {
  $('#save_and_add').val("1");
...
<div class="container">
	<div class="col-md-12">		
		<h1><?= __(ucfirst($action)) . ' ' . __(ucfirst($singular_nomenclature)) ?>
			| <?= HTML::anchor("admin/nomenclatures/{$controller}/index/".$nomenclature_name , __(ucfirst($nomenclature_name))) ?></h1>
